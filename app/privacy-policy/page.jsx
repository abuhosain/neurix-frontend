  ...
  return (
    <main className="bg-[#0a0b0d]">
      ...
      <div className="min-h-screen text-white">
        <motion.div
          className="w-full md:w-10/12 mx-auto px-4 md:px-12 py-8 md:py-16"
        ...
        >
          ...
          >
            ...
            <motion.p
              className="text-[#FFFFFFB3] text-base md:text-lg max-w-3xl mx-auto"
              variants={itemVariants}
            >
              Please read these Terms and Conditions carefully before using our
              services. By accessing or using Neurix, you agree to be bound by
              these terms.
            </motion.p>
            <motion.div
            ...
            <motion.div className="lg:w-3/4" variants={itemVariants}>
              <div className="space-y-8 md:space-y-12">
                ...
                >
                  ...
                  <div className="prose prose-invert max-w-none">
                    <p className="text-[#FFFFFFB3] leading-relaxed mb-4">
                      Welcome to Neurix, a cloud platform designed for ambitious
                      eCommerce brands and SaaS startups. These Terms and
                      Conditions (&quot;Terms&quot;) govern your use of our
                      website, services, and products provided by Nextup Global
                      Ltd.
                    </p>
                ...
                >
                  ...
                  <div className="prose prose-invert max-w-none">
                    <p className="text-[#FFFFFFB3] leading-relaxed mb-4">
                      By creating an account, making a purchase, or using any of
                      our services, you confirm that:
                    </p>
                ...
                >
                  ...
                  <div className="prose prose-invert max-w-none">
                    <p className="text-[#FFFFFFB3] leading-relaxed mb-4">
                      Neurix provides the following services:
                    </p>
                    <div className="grid md:grid-cols-2 gap-4 mb-6">
                      <div className="bg-[#0c0d12] border border-gray-800 rounded-lg p-4">
                        <h4 className="text-[#F2F4F7] font-semibold mb-2">
                          Domain Services
                        </h4>
                      ...
                      <div className="bg-[#0c0d12] border border-gray-800 rounded-lg p-4">
                        ...
                        <p className="text-[#99AAB6] text-sm">
                          Scalable cloud hosting and infrastructure solutions
                          (coming soon).
                        </p>
                      </div>
                    </div>
                    <p className="text-[#FFFFFFB3] leading-relaxed">
                      ...
                      any service at any time with reasonable notice to users.
                    </p>
                  </div>
                </motion.section>
                  ...
                  <div className="prose prose-invert max-w-none">
                    ...
                    <div className="bg-[#1a2332] border border-[#1488fc] rounded-lg p-4">
                      <p className="text-[#1488fc] text-sm font-medium">
                        💡 Security Tip: Use a strong, unique password and
                  ...
                  <div className="prose prose-invert max-w-none">
                    ...
                    <div className="space-y-4">
                      <div className="bg-[#0c0d12] border border-gray-800 rounded-lg p-4">
                        ...
                        <p className="text-[#99AAB6] text-sm">
                          All prices are clearly displayed and include
                          applicable taxes. No hidden fees.
                        </p>
                      </div>
                      <div className="bg-[#0c0d12] border border-gray-800 rounded-lg p-4">
                        <h4 className="text-[#F2F4F7] font-semibold mb-2">
                        ...
                        <p className="text-[#99AAB6] text-sm">
                          Services are billed in advance. Automatic renewal
                          applies unless cancelled.
                        </p>
                      </div>
                      <div className="bg-[#0c0d12] border border-gray-800 rounded-lg p-4">
                        <h4 className="text-[#F2F4F7] font-semibold mb-2">
                        ...
                        <p className="text-[#99AAB6] text-sm">
                          30-day money-back guarantee on hosting plans. Domain
                ...
                >
                  ...
                  <div className="prose prose-invert max-w-none">
                    <p className="text-[#FFFFFFB3] leading-relaxed mb-4">
                      ...
                      information in accordance with our Privacy Policy, which
                      includes:
                    </p>
                    <ul className="text-[#FFFFFFB3] leading-relaxed space-y-2 ml-6">
                  ...
                  <div className="prose prose-invert max-w-none">
                    ...
                    <div className="bg-gradient-to-r from-[#0c0d12] to-[#151619] border border-gray-800 rounded-xl p-6">
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          <h4 className="text-[#F2F4F7] font-semibold mb-3">
                            Company Information
                          </h4>
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            ...
                            <p className="text-[#99AAB6] text-sm">
                              Available 24/7 for all your questions and
                              concerns.
                            </p>
                          </div>
                        </div>
