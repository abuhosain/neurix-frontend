...
export default function Header() {
  return (
      ...
      <header
        ...
        style={{ backgroundImage: "url('/assets/hero/hero-bg-original-min.png')" }}
        >
        <main
          className="bg-contain bg-center bg-no-repeat"
          style={{ backgroundImage: "url('/assets/hero/noise-min.png')" }}
        >
          <section
            ...
            style={{ backgroundImage: "url('/assets/hero/solar-system.svg')" }}
          >
            <Navbar />
            <Hero />
            <LogoSlider />
